...
export class ExpLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(ExpLexer._LITERAL_NAMES, ExpLexer._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return ExpLexer.VOCABULARY;
	}
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(ExpLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return ExpLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return ExpLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return ExpLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return ExpLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!ExpLexer.__ATN) {
			ExpLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(ExpLexer._serializedATN));
		}

		return ExpLexer.__ATN;
	}
