...
import { ExpListener } from "./ExpListener";
import { ExpVisitor } from "./ExpVisitor";


export class ExpParser extends Parser {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(ExpParser._LITERAL_NAMES, ExpParser._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return ExpParser.VOCABULARY;
	}
	// tslint:enable:no-trailing-whitespace

	// @Override
	public get grammarFileName(): string { return "Exp.g4"; }

	// @Override
	public get ruleNames(): string[] { return ExpParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return ExpParser._serializedATN; }

	constructor(input: TokenStream) {
		super(input);
		this._interp = new ParserATNSimulator(ExpParser._ATN, this);
	}
	// @RuleVersion(0)
	public eval(): EvalContext {
		let _localctx: EvalContext = new EvalContext(this._ctx, this.state);
		this.enterRule(_localctx, 0, ExpParser.RULE_eval);
		try {
	...
	public additionExp(): AdditionExpContext {
		...
		this.enterRule(_localctx, 2, ExpParser.RULE_additionExp);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_la === ExpParser.T__0 || _la === ExpParser.T__1) {
				{
				this.state = 15;
				this._errHandler.sync(this);
	...
	public multiplyExp(): MultiplyExpContext {
		...
		this.enterRule(_localctx, 4, ExpParser.RULE_multiplyExp);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la === ExpParser.T__2 || _la === ExpParser.T__3) {
				{
				this.state = 25;
				this._errHandler.sync(this);
				switch (this._input.LA(1)) {
	...
	public atomExp(): AtomExpContext {
		...
		this.enterRule(_localctx, 6, ExpParser.RULE_atomExp);
		try {
			this.state = 35;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			...
			case ExpParser.T__4:
				...
				{
				this.state = 31;
				this.match(ExpParser.T__4);
				this.state = 32;
				this.additionExp();
				this.state = 33;
				this.match(ExpParser.T__5);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static get _ATN(): ATN {
		if (!ExpParser.__ATN) {
			ExpParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(ExpParser._serializedATN));
		}

		return ExpParser.__ATN;
	}
...
export class EvalContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return ExpParser.RULE_eval; }
	// @Override
	public enterRule(listener: ExpListener): void {
		if (listener.enterEval) {
			listener.enterEval(this);
		}
	}
	// @Override
	public exitRule(listener: ExpListener): void {
		if (listener.exitEval) {
			listener.exitEval(this);
		}
	}
	// @Override
	public accept<Result>(visitor: ExpVisitor<Result>): Result {
...
export class AdditionExpContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return ExpParser.RULE_additionExp; }
	// @Override
	public enterRule(listener: ExpListener): void {
...
export class MultiplyExpContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return ExpParser.RULE_multiplyExp; }
	// @Override
	public enterRule(listener: ExpListener): void {
...
export class AtomExpContext extends ParserRuleContext {
	public Number(): TerminalNode | undefined { return this.tryGetToken(ExpParser.Number, 0); }
	...
	// @Override
	public get ruleIndex(): number { return ExpParser.RULE_atomExp; }
	// @Override
	public enterRule(listener: ExpListener): void {
